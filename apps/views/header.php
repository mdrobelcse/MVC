...
.postcontent{width:540px;float: left;}
.post{line-height: 23px;padding: 20px;}
.post h2{}
.post a{text-decoration: none;}
.post p{text-align: justify;}
.readmore{float: right;background: #3399FF;padding:5px;border-radius: 4px;}
.readmore a{color:black;font-weight: bold;}
...
/* details page design*/
.details{border-bottom: 1px dashed #ddd;}
.title h2{margin: 0;}
...
.menu a{text-decoration: none;background: #f2f2f2;border: 1px solid #999;padding: 5px 10px; }
.search{float: right;}
.catsearch{
...
.loginform{width: 320px; margin: 50px auto; border: 1px solid #ddd;border-radius: 5px;
